  ...
  <DashboardLayout>
    <div class="container">
      ...
      <div v-else class="card">
        ...
        >
          <Column sortable field="id" header="ID" style="width: 100px">
            <template #body="slotProps">
              <span class="font-semibold text-blue-600">{{ slotProps.data.id }}</span>
            </template>
          </Column>
          ...
          <Column sortable field="stock" header="Stock" style="width: 120px">
            <template #body="slotProps">
              <span 
                class="px-2 py-1 rounded-full text-xs font-medium"
                :class="{
                  'bg-red-100 text-red-800': slotProps.data.stock === 0,
                  'bg-yellow-100 text-yellow-800': slotProps.data.stock > 0 && slotProps.data.stock < 10,
                  'bg-green-100 text-green-800': slotProps.data.stock >= 10
                }"
              >
                {{ slotProps.data.stock }} units
              </span>
            </template>
          </Column>
          
          <Column sortable field="price" header="Price" style="width: 150px">
            <template #body="slotProps">
        ...
        <!-- <div v-if="selectedProduct" class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <h4 class="font-semibold text-blue-900 mb-2">Selected Product:</h4>
